...
function Projects() {
    ...
    const categories = ["all", "academic", "internship", "python", "java", "OCaml", "HTML", "CSS", "R", "AI"];
    const buttonColors = {
      all: "#007bff", 
      academic: "#28a745",
      internship: "#ffc107", 
        ...
        {categories.map((category) => (
          <button
            ...
            style={{
                ...
                margin: "5px",
                borderRadius: "25px",  
                backgroundColor: selectedCategories.includes(category) ? buttonColors[category] : "#f0f0f0",
